...
const faqs = [
    {
        ...
        answer: "Listing your property on Zelax Properties is completely free. We only charge a small commission (3%) on completed bookings.",
    },
    {
        question: "What is the service fee for guests?",
        answer: "Guests pay a service fee of 12% of the booking total. This fee covers platform maintenance, customer support, and guest protection services.",
    },
    {
        question: "Are there any hidden fees?",
        answer: "No hidden fees. All fees are clearly displayed before booking. Hosts see the commission rate, and guests see the service fee upfront.",
    },
    {
        question: "When do I get paid as a host?",
        answer: "Hosts receive payment 24 hours after guest check-in. Payments are processed securely and can be transferred to your bank account.",
    },
    {
        question: "Can I change my pricing?",
        answer: "Yes, hosts can update their property pricing at any time. Changes take effect for new bookings immediately.",
    },
];

export function PricingPageContent() {
    const [calculatorAmount, setCalculatorAmount] = useState("100");
    const [calculatorType, setCalculatorType] = useState<"host" | "guest">(
        "host"
    );
                ...
                <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    >
                        ...
                        <p className='text-xl text-muted-foreground'>
                            Fair pricing for hosts and guests. No hidden fees,
                            no surprises.
                        </p>
                    </motion.div>
                </div>
                        ...
                        <Card>
                            ...
                            <CardContent className='space-y-6'>
                                <div className='flex gap-2'>
                                    ...
                                    <Button
                                        variant={
                                            calculatorType === "guest"
                                                ? "default"
                                                : "outline"
                                        }
                                        onClick={() =>
                                            setCalculatorType("guest")
                                        }
                                        className='flex-1'
                                    >
                                        I'm a Guest
