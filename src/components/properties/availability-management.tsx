    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage when your property is available</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <>
      <Card>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Override the base price for this date
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
        ...
        <CardContent>
          {availabilities?.results && availabilities.results.length > 0 ? (
              ...
              {availabilities.results.map((availability) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      variant={
                        availability.is_available ? "default" : "secondary"
                      }
                    >
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This availability entry will be
              permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
