...
import { BookingsManagement } from "@/components/properties/bookings-management";
        ...
        <div className='space-y-6'>
            ...
            <Tabs defaultValue='overview' className='space-y-4'>
                <TabsList>
                    ...
                    <TabsTrigger value='blocked-dates'>
                        Blocked Dates
                    </TabsTrigger>
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            ...
                            disabled={
                                !newStatus || updateStatusMutation.isPending
                            }
                        >
